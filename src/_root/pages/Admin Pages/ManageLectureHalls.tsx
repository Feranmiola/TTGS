...
const ManageLectureHalls = () => {
  ...
  return (
    ...
    <div className="flex flex-row">
      <h1 className="h2-bold py-14 px-16 text-blue-600">Manage Lecture Rooms</h1>
    </div>
        ...
        <TableContainer overflowY="auto">
          {searchValue ? (
            <Table variant="striped" colorScheme="gray" className="min-w-full divide-y divide-gray-300">
              <Thead>
                <Tr>
                  <Th className="px-6 py-3 whitespace-nowrap">Room Code</Th>
                  <Th className="px-6 py-3 whitespace-nowrap">Room Capacity</Th>
                  <Th className="px-6 py-3 whitespace-nowrap">RoomType</Th>
                  <Th className="px-6 py-3 whitespace-nowrap"></Th>
                </Tr>
              </Thead>
              <Tbody>
                {filteredRows.map(({ roomCode, capacity, type }, index) => (
                  <Tr key={index}>
                      <Td className="px-6 py-4 whitespace-nowrap">{roomCode}</Td>
              ...
              <Tbody>
              {currentData.map(({ roomCode, capacity, type }, index) => (
                  <Tr key={index}>
                    <Td className="px-6 py-4 whitespace-nowrap">{roomCode}</Td>
                    <Td className="px-6 py-4 whitespace-nowrap">{capacity}</Td>
