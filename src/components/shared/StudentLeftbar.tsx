    ...
    <div className='mx-10'>
          ...
          <Card className='bg-slate-100 w-40px'>
            ...
            <CardHeader className='flex flex-row'>
              ...
              <div>
                ...
                <CardDescription className='ml-4'>Student</CardDescription>
              </div>
      ...
      <Menu className=''>
        ...
        <div className='px-4 text-gray-500'>Your Dashboard</div>
          <MenuItem component={<Link to="/StudentHome" />} icon={<CalendarMonthIcon />} className={`hover:text-blue-600 ${useActive('/StudentHome')}`}>View Timetable</MenuItem>
